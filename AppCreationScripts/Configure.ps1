...
#> 
   ...
   Write-Host "Creating the AAD appplication (active-directory-dotnet-deviceprofile)"
   $clientAadApplication = New-AzureADApplication -DisplayName "active-directory-dotnet-deviceprofile" `
                                                  -ReplyUrls "https://active-directory-dotnet-deviceprofile" `
   ...
   $configFile = $pwd.Path + "\..\DirSearcherClient\Program.cs"
